...
open(19, status='old',file='./wat_pot/result_HWW_W.wat')
open(20, status='old',file='./hww_pot/result_HWW_W.hww')
...
!Initialize potential for HWW, using f(xx)
!Water monomer potential will be called by wat(x)
