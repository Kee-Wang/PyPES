...
real::Erot,J1,J1_sum,J2,J2_sum,J3,J3_sum,com_velc(3)
...
do j=1,4
write(21+j,'(A2,8A12)') '#J', '#Erot(HCl)','#Erot(WWW)',& 
'#Evib(HCl)', '#Evib(WWW)', '#Speed', '#Kin', 'Etot','D0'
end do
!write(22,*) '# No ZPE restriction'
!write(22,*) '# No ZPE restriction'
...
nhcl = 0
call fin_cond(mass(1:9),x_www,v_www,speed_www,Erot_www,j_www,abc_www)
...
red_h = Evib - zpe_hcl
write(*,*) red_w, red_h
kin_hwww = kin_hwww * aucm
E_tot = Erot+Erot_www+Evib+Evib_www+kin_hwww
D0 = E_given-zpe_hwww   - red_h - red_w
