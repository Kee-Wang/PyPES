...
file1 = 'j=4.prn'
file2 = ['../result_H_WWW.s1_j4','../result_H_WWW.s2_j4','../result_H_WWW.s3_j4','../result_H_WWW.s4_j4']
...
file1 = 'j=6.prn'
file2 = ['../result_H_WWW.s1_j6','../result_H_WWW.s2_j6','../result_H_WWW.s3_j6','../result_H_WWW.s4_j6']
...
file2 = ['../result_H_WWW.s1','../result_H_WWW.s2','../result_H_WWW.s3','../result_H_WWW.s4']
...
a =  np.loadtxt('../result_HWW_W.s1', unpack=True)
def j_w_plot(file2,save,ymax1,ymax2,xtitle,ytitle1,ytitle2,note,label):
    ...
    a = plot()
    a.save(fig=fig, save=save)
file2 = ['../result_HWW_W.s1','../result_HWW_W.s2','../result_HWW_W.s3','../result_HWW_W.s4']
