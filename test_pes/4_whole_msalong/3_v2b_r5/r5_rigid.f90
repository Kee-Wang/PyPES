...
nralpha=5;imin=2.5;imax=20;istep=0.01

!Change the dis(i)=0 if you don't want that paramter vary.
!
dis(1)=0.00;step(1)=0.001
dis(2)=0.00;step(2)=0.001
dis(3)=0.00;step(3)=0.001
dis(4)=0.00;step(4)=0.001
dis(5)=0;step(5)=0.05
dis(6)=0;step(6)=0.1
dis(7)=0;step(7)=0.1
dis(8)=0;step(8)=0.1!alpha1,set to 90 unless got correct cold for intcart.
dis(9)=0;step(9)=0.1
dis(10)=0;step(10)=0.1
dis(11)=0;step(11)=0.1
dis(12)=0;step(12)=0.1
!-----------------------------------------------------------------------------
