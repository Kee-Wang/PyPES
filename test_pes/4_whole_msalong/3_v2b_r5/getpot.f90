...
implicit none
  ...
  integer :: i, j, natm, numero,n,ierr, atom1,atom2
  real :: v, dis
...
do
    ...
    dis = sqrt(abs((xyz(1,atom1)-xyz(1,atom2))**2+(xyz(2,atom1)-xyz(2,atom2))**2+(xyz(3,atom1)-xyz(3,atom2))**2))
          write(14,*) natm
        write(14,*) v*aucm
     write(*,*) 'Distance in Ang: ',dis,'E in cm-1: ',v*aucm
     do i=1,natm
