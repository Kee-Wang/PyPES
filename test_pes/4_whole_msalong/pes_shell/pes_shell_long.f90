...
contains
  ...
  !==================================!
  subroutine pes_init_long()
    !::::::::::::::::::
    integer::i

    open(10,file='../pes_shell/coeff.dat',status='old')
  ...
  function g(xyz)
    ...
    a0 = 8  ! the same as in fitting code
