...
implicit none
 ...
 ! character,dimension(:),allocatable:: symb
  integer :: i, j, naatm, numero,n,ierr
  real :: v
 ...
 ! real,parameter::auang= 0.5291772083d0
  ...
  open(14,file=trim(bname)//'.cutdat',status='unknown')

  call  pes_init_co2h2o()
  read (12,*) natm
  read (12,*)
...
do
     ...
     !     write(14,*) natm
     write(14,*) distance(xyz,3,6), v*aucm
     write(*,*) distance(xyz,3,6), v*aucm
     !do i=1,natm
